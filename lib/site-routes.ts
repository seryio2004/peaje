...
export const SITE_PAGES = {
  ...
  "/": { title: "El Peaje: juego de cartas online gratis", description: "Juega a El Peaje gratis y sin registro. Predice cartas, cruza peajes y elige entre seis modos para jugar solo, en pareja o en grupo.", label: "Inicio" },
  "/jugar": { title: "Jugar a El Peaje online", description: "Empieza una partida gratis de El Peaje con una baraja de 52 cartas. Configura el modo y la dificultad para jugar solo, en pareja o en grupo.", label: "Jugar" },
